...
interface PromptEditorProps {
  ...
  onSave: (data: { title: string; content: string; mode: EditMode; tags: string[] }) => void
  onCancel: () => void
  loading?: boolean
}
            ...
            >
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">简化操作，智能辅助</p>
                </div>
                {editMode === 'normal' && (
                  <Badge className="ml-auto bg-teal-600">当前</Badge>
                )}
              </div>
            ...
            >
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">完全控制，高度自定义</p>
                </div>
                {editMode === 'professional' && (
                  <Badge className="ml-auto bg-emerald-600">当前</Badge>
                )}
              </div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center">
                  <Code2 className="h-4 w-4 text-emerald-500 mr-2" />
                  <span>结构化编辑</span>
                </div>
                <div className="flex items-center">
