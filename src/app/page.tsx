...
export default function NewPromptPage() {
  ...
  const handleOptimizedResult = (optimizedPrompt: string) => {
    setFormData(prev => ({ ...prev, content: optimizedPrompt }))
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: string) => setFormData(prev => ({ ...prev, folder_id: parseInt(value) }))}
                >
        ...
        <AIOptimizeDialog
          ...
          onOptimizedResult={handleOptimizedResult}
        />
      </main>
    </div>
  )
